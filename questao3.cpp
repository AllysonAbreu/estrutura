...
printf("\nA cidade %d não possui saida direta para a cidade %d", k, coluna);
}
}
}
}
...
if(entra != 0 || sai != 0){
printf("A cidade %d não eh isolada\n", l);
}
else{
printf("A cidade %d eh isolada\n", l);
}
}
printf("\nCidades que não há saida mas há entrada\n");
int k;
for(k=0; k<tamanho; k++){
int entra = entrada(tamanho, tamanhoVet, matriz, k);
int sai = saida(tamanho, tamanhoVet, matriz, k);
if(entra == FALSE && sai != FALSE){
printf("A cidade %d possui entrada mas não possui saida\n", k);
}
}
printf("\nCidades que não há entrada mas há saida\n");
for(k=0; k<tamanho; k++){
int entra = entrada(tamanho, tamanhoVet, matriz, k);
int sai = saida(tamanho, tamanhoVet, matriz, k);
if(sai == FALSE && entra != FALSE){
printf("A cidade %d possui saida mas não possui entrada\n",k);
}
}
...
if(seq == FALSE){
printf("Não eh possivel fazer esse caminho entre as cidades");
}
else{
